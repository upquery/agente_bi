...
--
  CREATE TABLE CTB_TIPO_BANCO 
   (	CD_TIPO_BANCO VARCHAR2(40), 
	DS_TIPO_BANCO VARCHAR2(50)
   ) ;
ALTER TABLE CTB_TIPO_BANCO ADD CONSTRAINT CTB_TIPO_BANCO_PK PRIMARY KEY (CD_TIPO_BANCO);      
--
  CREATE TABLE CTB_SISTEMAS 
   (CD_SISTEMA VARCHAR2(200) NOT NULL, 
	DS_SISTEMA VARCHAR2(200)NOT NULL
   ) ;
ALTER TABLE CTB_SISTEMAS ADD CONSTRAINT CTB_SISTEMAS_PK PRIMARY KEY (CD_SISTEMA);
--
...
ALTER TABLE CTB_CONEXOES ADD CONSTRAINT CTB_CONEXOES_PK PRIMARY KEY (ID_CLIENTE, ID_CONEXAO);
--
...
CREATE TABLE CTB_ACOES 
   (ID_CLIENTE VARCHAR2(20) not null, 
	...
	CD_SISTEMA VARCHAR2(30) not null, 
	CD_TIPO_BANCO VARCHAR2(30) not null, 
	TIPO_COMANDO VARCHAR2(20) not null, 
	COMANDO CLOB, 
	COMANDO_LIMPAR CLOB
   ) ;
alter table CTB_ACOES  add constraint CTB_ACOES_pk primary key (id_cliente, id_acao);
create index CTB_ACOES_idx001 on CTB_ACOES  (cd_sistema);      
create index CTB_ACOES_idx002 on CTB_ACOES  (cd_tipo_banco);      
--
