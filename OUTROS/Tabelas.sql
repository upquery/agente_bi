Usuários do BI: dwu 
Usuário do agente: agente (utilizado para conexão externa pelo agente)

Grants dwu: mesmo de qualquer BI 
Grants agente: 
	grant connect to agente;
	GRANT ALTER,SELECT,INSERT,DELETE,UPDATE,REFERENCES on DWU.ctb_docs to agente;
	GRANT EXECUTE on DWU.agentc to agente;
...
--
  CREATE TABLE CTB_RUN_PARAM 
   (ID_RUN VARCHAR2(30), 
	...
	ID_ENTREASPAS  VARCHAR2(1) DEFAULT 'N',
	ID_SCHEDULE    VARCHAR2(20) DEFAULT '0'
   ) ;
ALTER TABLE CTB_RUN_PARAM ADD CONSTRAINT CTB_RUN_PARAM_PK PRIMARY KEY (ID_RUN, ID_SCHEDULE, CD_PARAMETRO);    
--
...
--
CREATE TABLE CTB_DOCS    -- não criar PK ou unique index - dá problema na importação de arquivos via http
   (NAME VARCHAR2(300 BYTE), 
	...
	BLOB_CONTENT BLOB, 
	ID_CLIENTE VARCHAR2(12 BYTE), 
	CHECK_ID VARCHAR2(40 BYTE), 
	ID_ACAO VARCHAR2(40 BYTE), 
	ID_AGENDAMENTO VARCHAR2(40 BYTE), 
	ID_RUN_ACAO VARCHAR2(30 BYTE),
	STATUS VARCHAR2(30 BYTE), 
	DS_ERRO VARCHAR2(4000 BYTE), 
	DT_INICIO DATE, 
	DT_FIM DATE,
	ID_RUN_ACAO  VARCHAR2(30) ); 
--
